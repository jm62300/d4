...
#include "PartialOrderHeuristicTreeDecompCircuit.hpp"
...
/**
 * @brief
 * PartialOrderHeuristicTreeDecompCircuit::PartialOrderHeuristicTreeDecompCircuit
 * implementation.
 */
PartialOrderHeuristicTreeDecompCircuit::PartialOrderHeuristicTreeDecompCircuit(
  ...
  TreeDecomposition *decomp =
      TreeDecomposition::makeTreeDecomposition(options, PB_CIRC, out);
...
PartialOrderHeuristicTreeDecompCircuit::
    ~PartialOrderHeuristicTreeDecompCircuit() {}  // destructor
