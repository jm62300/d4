...
("partitioning-heuristic-bipartite-phase",boost::program_options::value<bool>()->default_value(true),"Use a static decomposition when the number of variable is 'huge'. Switch to the dynamic decomposition otherwise.")
