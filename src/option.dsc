...
("cache-reduction-strategy-expectation-size-first-page,crsesfp", boost::program_options::value<unsigned long>()->default_value((1UL<<30)), "The size of the initila page for the expectation strategy.")
...
("cache-size-additional-page", boost::program_options::value<unsigned long>()->default_value((1UL<<28)), "The block size of memory allocated for the next page of the cache structure.")
...
("cache-limit-ratio-number-variable", boost::program_options::value<double>()->default_value(0.1), "For the dynamic limit, we keep x% more than the last hit variable.")
