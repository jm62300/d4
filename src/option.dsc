...
("output-format-solution", boost::program_options::value<string>()->default_value("classic"), "The way the solution is printed out (classic is the SAT competition format and competition is the MC competition format).")
