...
("preproc-reducer-iteration",boost::program_options::value<int>()->default_value(1), "The number of iterations for the preproc that call reducer (-1 means we want to apply until we reach a fix point).")
("preproc-timeout",boost::program_options::value<int>()->default_value(-1), "The time in second given to the preproc (-1 means no timeout).")
