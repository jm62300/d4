...
/**
   Constructor.
 */
DataInfoCnfCl::DataInfoCnfCl(unsigned szData, unsigned nbVar, unsigned nbLit,
...
void DataInfoCnfCl::print(char *data, std::ostream &out) {
  ...
  switch (nbOctetsVar()) {
  case 1:
    printData<uint8_t>(data, nbVar(), out);
    break;
  case 2:
    printData<uint16_t>(data, nbVar(), out);
    break;
  default:
    printData<uint32_t>(data, nbVar(), out);
    break;
  }
  ...
  case 1:
    printData<uint8_t>(dataDistrib, nbDistrib() << 1, out);
    break;
  case 2:
    printData<uint16_t>(dataDistrib, nbDistrib() << 1, out);
    break;
  default:
    printData<uint32_t>(dataDistrib, nbDistrib() << 1, out);
    break;
  }
  ...
  switch (nbOctetLit()) {
  case 1:
    printData<uint8_t>(dataClause, nbLit(), out);
    break;
  case 2:
    printData<uint16_t>(dataClause, nbLit(), out);
    break;
  default:
    printData<uint32_t>(dataClause, nbLit(), out);
    break;
  }
