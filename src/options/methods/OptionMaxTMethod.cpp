...
#include "OptionMaxTMethod.hpp"

namespace d4 {

/**
 * @brief OptionMaxTMethod::OptionMaxTMethod implementation.
 */
OptionMaxTMethod::OptionMaxTMethod(const ConfigurationMaxTMethod& config)
