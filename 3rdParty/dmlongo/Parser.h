// Models a parser for parsing the hypergraph given in an appropriate file
// format and stores the information in preliminary data structures.
//
//////////////////////////////////////////////////////////////////////
...
class Parser {
 private:
  ...
  // Reads an identifier (i.e., name of an atom or a variable) from the input
  // file
  char *readIdentifier();
  ...
  // Reads an atom (including its variables) from the file and stores the
  // information in the above data structures
  void readAtom();

  // Reads a variable from the file and stores the information in the above data
  // structures
  void readVariable();
 ...
 public:
  ...
  // Parses the hypergraph in a given file and stores the information in
  ...
  // Returns the number of atoms that are neighbours (i.e., have common
  // variables) of a given atom
  int getNbrOfAtomNeighbours(int iAtom) const;

  // Returns the number of variables that are neighbours (i.e., have common
  // atoms) of a given variable
  ...
  // Returns successively the variables belonging to atoms in the following
  // order: V0 of A0, V1 of A0, V2 of A0, ..., Vn0 of A0, V0 of A1, V1 of A1,
  // ..., Vn1 of A1, V0 of A2, ...
  int getNextAtomVar(bool bReset = false);

  // Returns successively the atoms to which the variables belong in the
  // following order: A0 of V0, A1 of V0, A2 of V0, ..., An0 of V0, A0 of V1, A1
  // of V1, ..., An1 of V1, A0 of V2, ...
  int getNextVarAtom(bool bReset = false);

  // Returns successively the neighbours belonging to atoms in the following
  // order: N0 of A0, N1 of A0, N2 of A0, ..., Nn0 of A0, N0 of A1, N1 of A1,
  // ..., Nn1 of A1, N0 of A2, ...
  int getNextAtomNeighbour(bool bReset = false);

  // Returns successively the neighbours belonging to variables in the following
  // order: N0 of V0, N1 of V0, N2 of V0, ..., Nn0 of V0, N0 of V1, N1 of V1,
  // ..., Nn1 of V1, N0 of V2, ...
