...
namespace htd
{
    ...
    class ConstIteratorWrapper : public htd::ConstIteratorBase<T>
    {
        public:
            /**
             ...
             */
            ConstIteratorWrapper(const ConstIteratorWrapper<Iter, T> & original) HTD_NOEXCEPT : baseIterator_(original.baseIterator_)
            {
             ...
             *  @param[in] original  The original iterator wrapper.
             */
            ConstIteratorWrapper(ConstIteratorWrapper<Iter, T> && original) HTD_NOEXCEPT : baseIterator_(std::move(original.baseIterator_))
            {
