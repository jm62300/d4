...
{
    /**
     *  Implementation of a directed graph in which vertices and edges can be accessed by their names.
     */
    ...
    class NamedDirectedGraph
    {
        public:
             ...
             */
            NamedDirectedGraph(const htd::LibraryInstance * const manager) : base_(manager->labeledDirectedGraphFactory().createInstance()), names_(), vertexCreationFunction_(std::bind(&htd::IMutableLabeledDirectedGraph::addVertex, base_))
            {
             ...
             *
             *  @param[in] vertexName   The name of the vertex for which the collection of incoming neighbors shall be returned.
             *
             ...
             *
             *  @param[in] vertexName   The name of the for which the incoming neighbor shall be returned.
             ...
             *
             *  @param[in] vertexName   The name of the vertex for which the collection of outgoing neighbors shall be returned.
             *
             ...
             *
             *  @param[in] vertexName   The name of the vertex for which the outgoing neighbor shall be returned.
            ...
            /**
             *  Add a new vertex to the directed graph if it does not already exist.
             *
            ...
            /**
             *  Add new vertices to the directed graph if they do not already exist.
             *
             *  @param[in] vertexNames  The names of the vertices which shall be added.
             *
             *  @return A vector containing for each provided vertex name the ID of the vertex in the directed graph. Existing vertices keep their ID.
             */
            ...
            /**
             *  Add a new edge to the directed graph if it does not already exist.
             *
             *  @param[in] vertexName1  The first endpoint of the edge.
             *  @param[in] vertexName2  The second endpoint of the edge.
             *
