...
namespace htd
{
    ...
    class ConstPointerIteratorWrapper : public htd::ConstIteratorBase<T>
    {
        public:
            /**
             *  Iterator member types, replacing the inheritance from
             *  std::iterator (deprecated since C++17).
             */
             ...
             */
            ConstPointerIteratorWrapper(const ConstPointerIteratorWrapper<Iter, T> & original) HTD_NOEXCEPT : baseIterator_(original.baseIterator_)
            {
             ...
             *  @param[in] original  The original iterator wrapper.
             */
            ConstPointerIteratorWrapper(ConstPointerIteratorWrapper<Iter, T> && original) HTD_NOEXCEPT : baseIterator_(std::move(original.baseIterator_))
            {
