...
namespace htd
{
    ...
    class IteratorWrapper : public htd::IteratorBase<T>
    {
            public:
            /**
             ...
             */
            IteratorWrapper(const IteratorWrapper<Iter, T> & original) : baseIterator_(original.baseIterator_)
            {
             ...
             *  @param[in] original  The original iterator wrapper.
             */
            IteratorWrapper(IteratorWrapper<Iter, T> && original) : baseIterator_(std::move(original.baseIterator_))
            {
