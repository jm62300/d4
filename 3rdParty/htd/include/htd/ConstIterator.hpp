...
namespace htd
{
    ...
    class ConstIterator : public htd::ConstIteratorBase<T>
    {
        public:
             ...
             */
            ConstIterator(const ConstIterator<T> & original) HTD_NOEXCEPT : baseIterator_(nullptr)
            {
             ...
             *  @param[in] original  The original iterator.
             */
            ConstIterator(ConstIterator<T> && original) HTD_NOEXCEPT : baseIterator_(nullptr)
            {
                if (original.baseIterator_ != nullptr)
                {
