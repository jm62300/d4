...
MODEL_COUNTER="./d4_static -m counting -f 1 -i"
TESTED_METHOD="../demo/maxT/build/maxT -i"
COMPARED_METHOD="python3 bruteForceMaxT.py"
...
echo "c p show $maxVar" >> $fileTmp
grep "c p weight" /tmp/bench.cnf >> $fileTmp
