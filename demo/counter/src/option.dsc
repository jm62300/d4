...
("partitioning-heuristic,pvh",boost::program_options::value<std::string>()->default_value("tree-decomposition"),"The method used to compute a cut. [none, tree-decomposition]")
("partitioning-heuristic-partitioner,php",boost::program_options::value<std::string>()->default_value("patoh"),"The partitioner we will call (patoh).")
