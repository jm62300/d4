...
namespace reducer {
/**
 * @brief Propagator::Propagator implementation.
 */
Propagator::Propagator(unsigned nbVar, std::vector<std::vector<Lit>>& clauses,
                       std::ostream& out, bool verbose)
    : m_out(out), m_verbose(verbose) {
  if (m_verbose) m_out << "c [REDUCER PROPAGATOR] Construtor\n";
  ...
  if (m_verbose)
    m_out << "c [REDUCER PROPAGATOR] Memory needed: " << memoryNeeded << "\n"
          << "c [REDUCER PROPAGATOR] Binary clauses: " << nbClauseBin << "\n"
          << "c [REDUCER PROPAGATOR] Not binary clauses: " << nbClauseNotBin
          << "\n"
          << "c [REDUCER PROPAGATOR] Number of literals in not binary clauses: "
          << nbLitNotBin << "\n";
...
/**
 * @brief Propagator::addBinary implementation.
 */
...
/**
 * @brief Propagator::addClause implementation.
 */
...
/**
 * @brief Propagator::uncheckedEnqueue implementation.
 */
...
/**
 * @brief Propagator::propagate implementation.
 */
...
/**
 * @brief Propagator::display implementation.
 */
...
/**
 * @brief Propagator::attachClause implementation.
 */
...
/**
 * @brief Propagator::detachClause implementation.
 */
...
/**
 * @brief Propagator::extractFormula implementation.
 */
...
/**
 * @brief Propagator::restart implementation.
 */
...
/**
 * @brief Propagator::cancelUntilPos implementation.
 */
