...
namespace reducer {
/**
 * @brief OccElimination::OccElimination object
 */
...
/**
 * @brief OccElimination::run implementation.
 */
...
void OccElimination::run(Propagator& propagator, int nbIteration, bool verbose,
  ...
  for (int iteration = 0;
    ...
    removeLitFromLargeClauses(propagator, occurrence, timer);
...
/**
 * @brief OccElimination::generateOccurrenceLit implementation
 *
 */
...
/**
 * @brief OccElimination::generateLitList implementation.
 */
...
/**
 * @brief OccElimination::removeLitFromLargeClauses implementation.
 *
 */
void OccElimination::removeLitFromLargeClauses(
  ...
  for (auto& l : litList) {
    ...
    if (propagator.getIsUnsat() || timer.isTimeout()) break;
  }
...
/**
 * @brief OccElimination::occRemoveBin implementation.
 *
 */
...
/**
 * @brief OccElimination::displayInfo implementation.
 */
