...
/**
 * @brief  DACircuit::constructImpliedList implementation.
 */
...
/**
 * @brief  DACircuit::extractEquivClass implementation.
 */
...
/**
 * @brief DACircuit::getScore implementation.
 */
...
/**
 * @brief DACircuit::identifyEquiv implementation.
 */
...
/**
 * @brief DACircuit::identifyAndGate implementation.
 */
void DACircuit::identifyAndGate(Problem& p, std::vector<Gate>& listOfGates,
  ...
  while (!timer.isTimeout() && remainingVar.size()) {
...
/**
 * @brief DACircuit::canBuildXor implementation.
 */
...
/**
 * @brief DACircuit::identifyXorGate implementation.
 */
...
/**
 * @brief  DACircuit::init implementation.
 */
...
/**
 * @brief DACircuit::addRelation implementation.
 */
...
/**
 * @brief DACircuit::markDescendant implementation.
 */
...
/**
 * @brief DACircuit::unmarkDescendant implementation.
 */
...
/**
 * @brief DACircuit::run implementation.
 */
