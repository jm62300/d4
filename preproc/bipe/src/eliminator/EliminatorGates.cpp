...
/**
 * @brief EliminatorGates::EliminatorGates implementation.
 *
 */
...
/**
 * @brief EliminatorGates::eliminateDac implementation.
 *
 */
void EliminatorGates::eliminate(unsigned nbVar,
  ...
  while (!timer.isTimeout() && (units.size() || modification)) {
    modification = false;
...
/**
 * @brief EliminatorGates::removeUnit implementation.
 */
...
/**
 * @brief EliminatorGates::eliminateOneOr implementation.
 */
...
/**
 * @brief EliminatorGates::eliminateOneXor implementation.
 */
...
/**
 * @brief EliminatorGates::canBeUsed implementation.
 */
...
/**
 * @brief EliminatorGates::eliminateOneGate implementation.
 */
